...
The map button sends distinct translucent transmitter and receiver antenna-pattern polygons to open Map features. The polygons show the horizontal sector between the near and far HPBW elevation limits at the selected maximum altitude, which defaults to 1000 km. The GRAVES defaults use approximately 180 degrees of southern azimuthal coverage and 25 degrees of vertical HPBW. A zero horizontal coverage or HPBW leaves that antenna pattern unspecified and suppresses its polygon.
