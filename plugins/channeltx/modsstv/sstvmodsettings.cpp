...
SSTVModSettings::SSTVModeParams SSTVModSettings::getModeParams(SSTVMode mode)
{
...
bool SSTVModSettings::deserialize(const QByteArray& data)
{
    ...
    if (d.getVersion() == 1)
    {
        ...
        d.readS32(22, &tmp, (int) SSTVMode::PD120);
        m_sstvMode = (tmp >= 0 && tmp <= 12) ? static_cast<SSTVMode>(tmp) : SSTVMode::PD120;
