...
private slots:
    ...
    void on_trackObjectLabelDisplayCombo_currentIndexChanged(int index);
    void on_trackObjectLabelDetectionRadiusSpin_valueChanged(double value);
    ...
    void on_cloudDetectButton_toggled(bool checked);
    void on_cloudModeCombo_currentIndexChanged(int index);
    void on_cloudDebugViewCombo_currentIndexChanged(int index);
    void on_cloudDayThresholdSpin_valueChanged(double value);
    void on_cloudTextureThresholdSpin_valueChanged(int value);
    void on_cloudNightThresholdSpin_valueChanged(int value);
    void on_cloudBackgroundBlurSpin_valueChanged(int value);
    void on_cloudDownscaleCombo_currentIndexChanged(int index);
    void on_cloudOpenSizeSpin_valueChanged(int value);
    void on_cloudCloseSizeSpin_valueChanged(int value);
    void on_cloudUpdateIntervalSpin_valueChanged(int value);
    void on_cloudShowOverlayCheck_toggled(bool checked);
    void on_cloudFilterStarsCheck_toggled(bool checked);
    ...
    void on_cloudMinElevationSpin_valueChanged(double value);
    ...
    void on_cloudDayRelativeMarginSpin_valueChanged(double value);
    ...
    void on_cloudSaveTestCaseButton_clicked();
