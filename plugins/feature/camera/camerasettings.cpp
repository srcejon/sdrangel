...
QByteArray CameraSettings::serialize() const
{
    ...
    s.writeS32(24, m_stackHdrExposureCount);
    s.writeDouble(25, m_stackHdrExposureTimesMs[0]);
    s.writeDouble(26, m_stackHdrExposureTimesMs[1]);
    s.writeDouble(27, m_stackHdrExposureTimesMs[2]);
    s.writeDouble(28, m_stackHdrExposureTimesMs[3]);
    s.writeS32(29, m_stackAlignmentMethod);
    s.writeString(30, m_stackDarkFileName);
    s.writeString(31, m_stackFlatFileName);
    s.writeString(32, m_stackBiasFileName);
    s.writeFloat(33, m_latitude);
    s.writeFloat(34, m_longitude);
    s.writeFloat(35, m_altitude);
    s.writeBool(36, m_positionSync);
    s.writeString(37, m_owmAPIKey);
    s.writeFloat(38, m_azimuth);
    s.writeFloat(39, m_elevation);
    s.writeFloat(40, m_roll);
    s.writeString(41, m_rotator);
    s.writeFloat(42, m_fov);
    s.writeS32(43, m_lensProjection);
    s.writeDouble(44, m_lensCenterOffsetX);
    s.writeDouble(45, m_lensCenterOffsetY);
    s.writeDouble(46, m_lensDistortionK1);
    s.writeBool(47, m_scheduleEnabled);
    s.writeString(48, m_scheduleStartTime);
    s.writeString(49, m_scheduleEndTime);
    s.writeS32(50, m_scheduleWeekdays);

    if (m_rollupState) {
        s.writeBlob(51, m_rollupState->serialize());
    }

    s.writeS32(52, m_workspaceIndex);
    s.writeBlob(53, m_geometryBytes);
    s.writeS32(54, m_cameraBinX);
    s.writeS32(55, m_cameraBinY);
    s.writeS32(56, m_cameraGain);
    s.writeS32(57, m_cameraReadoutMode);
    s.writeS32(58, m_cameraOffset);
    s.writeS32(59, m_cameraNumX);
    s.writeS32(60, m_cameraNumY);
    s.writeS32(61, m_cameraStartX);
    s.writeS32(62, m_cameraStartY);
    s.writeS32(63, m_postProcessWhiteBalanceMode);
    s.writeDouble(64, m_postProcessWhiteBalanceRedGain);
    s.writeDouble(65, m_postProcessWhiteBalanceGreenGain);
    s.writeDouble(66, m_postProcessWhiteBalanceBlueGain);
    s.writeBool(67, m_postProcessUnwarp);
    s.writeS32(68, static_cast<qint32>(m_histogramStretch));
    s.writeDouble(69, m_histogramStretchBlackPoint);
    s.writeDouble(70, m_histogramStretchWhitePoint);
    s.writeDouble(71, m_histogramStretchGamma);
    s.writeDouble(72, m_histogramStretchAsinhStrength);
    s.writeDouble(73, m_histogramStretchLogStrength);
    s.writeBool(74, m_postProcessGreyscale);
    s.writeDouble(75, m_saturation);
    s.writeDouble(76, m_gamma);
    s.writeS32(77, m_gaussianBlur);
    s.writeS32(78, m_medianBlur);
    s.writeDouble(79, m_sharpen);
    s.writeS32(80, static_cast<qint32>(m_edgeDisplayMode));
    s.writeDouble(81, m_sobelEdge);
    s.writeDouble(82, m_cannyEdge);
    s.writeDouble(83, m_lineEnhancement);
    s.writeDouble(84, m_ridgeDetection);
    s.writeS32(85, m_ridgeDetectionKernelSize);
    s.writeDouble(86, m_ridgeDetectionScale);
    s.writeDouble(87, m_ridgeDetectionDelta);
    s.writeBool(88, m_flipX);
    s.writeBool(89, m_flipY);
    s.writeDouble(90, m_brightness);
    s.writeDouble(91, m_contrast);
    s.writeBool(92, m_invertColors);
    s.writeBool(93, m_overlayDateTime);
    s.writeU32(94, m_dateTimeColor.rgba());
    s.writeBool(95, m_diffMask);
    s.writeS32(96, m_diffThreshold);
    s.writeS32(97, m_dilationSize);
    s.writeS32(98, m_diffMaskHistoryFrames);
    s.writeS32(99, m_diffMaskCloseSize);
    s.writeString(100, m_overlayFontFamily);
    s.writeDouble(101, m_overlayFontScale);
    s.writeS32(102, m_detectionRoiX);
    s.writeS32(103, m_detectionRoiY);
    s.writeS32(104, m_detectionRoiWidth);
    s.writeS32(105, m_detectionRoiHeight);
    s.writeBool(106, m_showDetectionRoi);
    s.writeBool(107, m_motionDetect);
    s.writeS32(108, static_cast<qint32>(m_motionBackgroundSubtractor));
    s.writeS32(109, static_cast<qint32>(m_motionMaskView));
    s.writeS32(110, m_motionHistory);
    s.writeDouble(111, m_motionVarThreshold);
    s.writeBool(112, m_motionDetectShadows);
    s.writeS32(113, m_motionOpenSize);
    s.writeS32(114, m_motionCloseSize);
    s.writeS32(115, m_motionPersistenceFrames);
    s.writeU32(116, m_motionBoxColor.rgba());
    s.writeS32(117, m_minContourArea);
    s.writeDouble(118, m_motionLearningRate);
    s.writeS32(119, m_motionConfirmFrames);
    s.writeDouble(120, m_motionDownscale);
    s.writeBlob(121, serializeMotionExclusionRects(m_motionExclusionRects));
    s.writeBool(122, m_showMotionExclusionRects);
    s.writeBool(123, m_starDetect);
    s.writeS32(124, m_starThreshold);
    s.writeS32(125, m_starBackgroundBlur);
    s.writeS32(126, m_starMinArea);
    s.writeS32(127, m_starMaxArea);
    s.writeDouble(128, m_starMaxAspectRatio);
    s.writeS32(129, static_cast<qint32>(m_starDebugView));
    s.writeU32(130, m_starColor.rgba());
    s.writeBool(131, m_plateSolve);
    s.writeDouble(132, m_plateSolveMaxMagnitude);
    s.writeS32(133, m_plateSolveMinMatches);
    s.writeDouble(134, m_plateSolveMatchRadius);
    s.writeDouble(135, m_plateSolveFinalMatchRadius);
    s.writeDouble(136, m_plateSolveSearchRadius);
    s.writeS32(137, static_cast<qint32>(m_plateSolveStartMode));
    s.writeBool(138, m_plateSolveUseDownloadedCatalog);
    s.writeBool(139, m_plateSolveUseCurrentDateTime);
    s.writeS64(140, m_plateSolveDateTime.isValid() ? m_plateSolveDateTime.toMSecsSinceEpoch() : 0);
    s.writeS32(141, static_cast<qint32>(m_plateSolveApplyMode));
    s.writeS32(142, static_cast<qint32>(m_plateSolveLabelMode));
    s.writeBool(143, m_overlaySpectrum);
    s.writeString(144, m_spectrumDevice);
    s.writeS32(145, m_spectrumOffsetX);
    s.writeS32(146, m_spectrumOffsetY);
    s.writeDouble(147, m_spectrumScale);
    s.writeString(148, m_dateTimeFormat);
    s.writeS32(149, m_dateTimePosX);
    s.writeS32(150, m_dateTimePosY);
    s.writeBool(151, m_overlayText);
    s.writeString(152, m_overlayTextString);
    s.writeU32(153, m_overlayTextColor.rgba());
    s.writeString(154, m_overlayTextFontFamily);
    s.writeDouble(155, m_overlayTextFontScale);
    s.writeS32(156, m_overlayTextPosX);
    s.writeS32(157, m_overlayTextPosY);
    s.writeBool(158, m_equatorialGrid);
    s.writeU32(159, m_equatorialGridColor.rgba());
    s.writeBool(160, m_altAzGrid);
    s.writeU32(161, m_altAzGridColor.rgba());
    s.writeBool(162, m_constellation);
    s.writeU32(163, m_constellationColor.rgba());
    s.writeS32(164, static_cast<qint32>(m_constellationOverlay));
    s.writeBool(165, m_trackObjects);
    s.writeDouble(166, m_trackObjectMinElevation);
    s.writeU32(167, m_trackObjectColor.rgba());
    s.writeDouble(168, m_trackObjectFontScale);
    s.writeString(169, m_gridLabelFontFamily);
    s.writeDouble(170, m_gridLabelFontScale);
    s.writeBool(171, m_yoloEnabled);
    s.writeString(172, m_yoloModelPath);
    s.writeString(173, m_yoloLabelsPath);
    s.writeDouble(174, m_yoloConfThreshold);
    s.writeDouble(175, m_yoloNmsThreshold);
    s.writeU32(176, m_yoloBoxColor.rgba());
    s.writeDouble(177, m_yoloDisappearDebounce);
    s.writeS32(178, m_yoloDnnTarget);
    s.writeBlob(179, serializeObjectDeviceSettings(m_objectDeviceSettings));
    s.writeBool(180, m_audioMute);
    s.writeString(181, m_audioDeviceName);
    s.writeS32(182, m_whiteBalanceMode);
    s.writeDouble(183, m_exposureCompensation);
    s.writeS32(184, m_focusMode);
    s.writeDouble(185, m_focusDistance);
    s.writeDouble(186, m_zoomFactor);
    s.writeDouble(187, m_captureInterval);
    s.writeS32(188, m_captureIntervalUnits);
    s.writeBool(189, m_alpacaDiscoveryEnabled);
    s.writeBool(190, m_alpacaApiLogEnabled);
    s.writeBool(191, m_alpacaFocuserEnabled);
    s.writeString(192, m_alpacaFocuserHost);
    s.writeU32(193, m_alpacaFocuserPort);
    s.writeS32(194, m_alpacaFocuserDeviceNumber);
    s.writeS32(195, m_alpacaFocusPosition);
    s.writeS32(196, m_alpacaFocusStepSize);
    s.writeBool(197, m_alpacaFilterWheelEnabled);
    s.writeString(198, m_alpacaFilterWheelHost);
    s.writeU32(199, m_alpacaFilterWheelPort);
    s.writeS32(200, m_alpacaFilterWheelDeviceNumber);
    s.writeS32(201, m_alpacaFilterWheelPosition);
    s.writeString(202, m_videoFileCameraPath);

    s.writeBool(203, m_useReverseAPI);
    s.writeString(204, m_reverseAPIAddress);
    s.writeU32(205, m_reverseAPIPort);
    s.writeU32(206, m_reverseAPIFeatureSetIndex);
    s.writeU32(207, m_reverseAPIFeatureIndex);
    s.writeS32(208, m_asiCoolerOn);
    s.writeS32(209, m_asiTargetTemp);
    s.writeS32(210, m_asiUsbBandwidth);
    s.writeS32(211, m_asiHighSpeedMode);
    s.writeS32(212, m_asiColorImageType);
    s.writeS32(213, m_diffMaskOpenSize);
    s.writeS32(214, m_recordMode);
    s.writeBool(215, m_asiAutoExposureGain);
...
bool CameraSettings::deserialize(const QByteArray& data)
{
    ...
    if (d.getVersion() == 1)
    {
        ...
        d.readDouble(187, &m_captureInterval, 1.0);
        d.readS32(188, (qint32 *) &m_captureIntervalUnits, (qint32) CaptureIntervalSeconds);
        d.readBool(189, &m_alpacaDiscoveryEnabled, false);
        d.readBool(190, &m_alpacaApiLogEnabled, false);
        d.readBool(191, &m_alpacaFocuserEnabled, false);
        d.readString(192, &m_alpacaFocuserHost, "127.0.0.1");
        d.readU32(193, &utmp, 11111);
        m_alpacaFocuserPort = (utmp <= 65535) ? static_cast<uint16_t>(utmp) : 11111;
        d.readS32(194, &m_alpacaFocuserDeviceNumber, 0);
        d.readS32(195, &m_alpacaFocusPosition, 0);
        d.readS32(196, &m_alpacaFocusStepSize, 100);
        d.readBool(197, &m_alpacaFilterWheelEnabled, false);
        d.readString(198, &m_alpacaFilterWheelHost, "127.0.0.1");
        d.readU32(199, &utmp, 11111);
        m_alpacaFilterWheelPort = (utmp <= 65535) ? static_cast<uint16_t>(utmp) : 11111;
        d.readS32(200, &m_alpacaFilterWheelDeviceNumber, 0);
        d.readS32(201, &m_alpacaFilterWheelPosition, 0);
        ...
        d.readS32(24, &m_stackHdrExposureCount, 3);
        d.readDouble(25, &m_stackHdrExposureTimesMs[0], 12.5);
        d.readDouble(26, &m_stackHdrExposureTimesMs[1], 50.0);
        d.readDouble(27, &m_stackHdrExposureTimesMs[2], 200.0);
        d.readDouble(28, &m_stackHdrExposureTimesMs[3], 800.0);
        d.readS32(29, (qint32 *) &m_stackAlignmentMethod, (qint32) StackAlignmentNone);
        d.readString(30, &m_stackDarkFileName, "");
        d.readString(31, &m_stackFlatFileName, "");
        d.readString(32, &m_stackBiasFileName, "");
        d.readFloat(33, &m_latitude, MainCore::instance()->getSettings().getLatitude());
        d.readFloat(34, &m_longitude, MainCore::instance()->getSettings().getLongitude());
        d.readFloat(35, &m_altitude, MainCore::instance()->getSettings().getAltitude());
        d.readBool(36, &m_positionSync, false);
        d.readString(37, &m_owmAPIKey, "");
        d.readFloat(38, &m_azimuth, 0.0f);
        d.readFloat(39, &m_elevation, 0.0f);
        d.readFloat(40, &m_roll, 0.0f);
        d.readString(41, &m_rotator, "");
        d.readFloat(42, &m_fov, 60.0f);
        d.readS32(43, (int *) &m_lensProjection, LensProjectionRectilinear);
        d.readDouble(44, &m_lensCenterOffsetX, 0.0);
        d.readDouble(45, &m_lensCenterOffsetY, 0.0);
        d.readDouble(46, &m_lensDistortionK1, 0.0);
        d.readBool(47, &m_scheduleEnabled, false);
        d.readString(48, &m_scheduleStartTime, "20:00:00");
        d.readString(49, &m_scheduleEndTime, "06:00:00");
        d.readS32(50, &m_scheduleWeekdays, 0x7f);
        ...
        d.readS32(52, &m_workspaceIndex, 0);
        d.readBlob(53, &m_geometryBytes);
        d.readS32(54, &m_cameraBinX, 1);
        d.readS32(55, &m_cameraBinY, 1);
        d.readS32(56, &m_cameraGain, 100);
        d.readS32(57, &m_cameraReadoutMode, 0);
        d.readS32(58, &m_cameraOffset, 1);
        d.readS32(59, &m_cameraNumX, 0);
        d.readS32(60, &m_cameraNumY, 0);
        d.readS32(61, &m_cameraStartX, 0);
        d.readS32(62, &m_cameraStartY, 0);
        ...
        d.readS32(63, &m_postProcessWhiteBalanceMode, 0);
        d.readDouble(64, &m_postProcessWhiteBalanceRedGain, 1.0);
        d.readDouble(65, &m_postProcessWhiteBalanceGreenGain, 1.0);
        d.readDouble(66, &m_postProcessWhiteBalanceBlueGain, 1.0);
        d.readBool(67, &m_postProcessUnwarp, false);
        d.readS32(68, reinterpret_cast<qint32*>(&m_histogramStretch), static_cast<qint32>(HistogramStretchOff));
        d.readDouble(69, &m_histogramStretchBlackPoint, 0.0);
        d.readDouble(70, &m_histogramStretchWhitePoint, 1.0);
        d.readDouble(71, &m_histogramStretchGamma, 1.0);
        d.readDouble(72, &m_histogramStretchAsinhStrength, 10.0);
        d.readDouble(73, &m_histogramStretchLogStrength, 10.0);
        d.readBool(74, &m_postProcessGreyscale, false);
        d.readDouble(75, &m_saturation, 1.0);
        d.readDouble(76, &m_gamma, 1.0);
        ...
        d.readS32(80, &edgeDisplayMode, static_cast<qint32>(EdgeDisplayOverlay));
        ...
        d.readDouble(81, &m_sobelEdge, 0.0);
        d.readDouble(82, &m_cannyEdge, 0.0);
        d.readDouble(83, &m_lineEnhancement, 0.0);
        d.readDouble(84, &m_ridgeDetection, 0.0);
        d.readS32(85, &m_ridgeDetectionKernelSize, 3);
        d.readDouble(86, &m_ridgeDetectionScale, 1.0);
        d.readDouble(87, &m_ridgeDetectionDelta, 0.0);
        d.readBool(88, &m_flipX, false);
        d.readBool(89, &m_flipY, false);
        ...
        d.readDouble(90, &m_brightness, 0.0);
        d.readDouble(91, &m_contrast, 1.0);
        d.readBool(92, &m_invertColors, false);
        d.readBool(93, &m_overlayDateTime, false);
        uint32_t colorRgba = QColor(Qt::white).rgba();
        d.readU32(94, &colorRgba, QColor(Qt::white).rgba());
        m_dateTimeColor = QColor::fromRgba(colorRgba);
        d.readBool(95, &m_diffMask, false);
        d.readS32(96, &m_diffThreshold, 30);
        d.readS32(97, &m_dilationSize, 3);
        d.readS32(98, &m_diffMaskHistoryFrames, 1);
        d.readS32(99, &m_diffMaskCloseSize, 0);
        d.readS32(213, &m_diffMaskOpenSize, 0);
        ...
        d.readString(100, &m_overlayFontFamily, "");
        d.readDouble(101, &m_overlayFontScale, 12.0);
        d.readS32(102, &m_detectionRoiX, 0);
        d.readS32(103, &m_detectionRoiY, 0);
        d.readS32(104, &m_detectionRoiWidth, 0);
        d.readS32(105, &m_detectionRoiHeight, 0);
        d.readBool(106, &m_showDetectionRoi, true);
        d.readBool(107, &m_motionDetect, false);
        qint32 motionBackgroundSubtractor = static_cast<qint32>(MotionBackgroundSubtractorMOG2);
        d.readS32(108, &motionBackgroundSubtractor, static_cast<qint32>(MotionBackgroundSubtractorMOG2));
        ...
        d.readS32(109, &motionMaskView, static_cast<qint32>(MotionMaskViewOff));
        ...
        d.readS32(110, &m_motionHistory, 500);
        d.readDouble(111, &m_motionVarThreshold, 16.0);
        d.readDouble(118, &m_motionLearningRate, -1.0);
        d.readS32(119, &m_motionConfirmFrames, 1);
        d.readDouble(120, &m_motionDownscale, 1.0);
        d.readBool(112, &m_motionDetectShadows, true);
        d.readS32(113, &m_motionOpenSize, 0);
        d.readS32(114, &m_motionCloseSize, 0);
        d.readS32(115, &m_motionPersistenceFrames, 0);
        uint32_t motionBoxColorRgba = QColor(Qt::red).rgba();
        d.readU32(116, &motionBoxColorRgba, QColor(Qt::red).rgba());
        m_motionBoxColor = QColor::fromRgba(motionBoxColorRgba);
        d.readS32(117, &m_minContourArea, 100);
        d.readBlob(121, &bytetmp);
        deserializeMotionExclusionRects(bytetmp, m_motionExclusionRects);
        d.readBool(122, &m_showMotionExclusionRects, true);
        d.readBool(123, &m_starDetect, false);
        d.readS32(124, &m_starThreshold, 24);
        d.readS32(125, &m_starBackgroundBlur, 12);
        d.readS32(126, &m_starMinArea, 1);
        d.readS32(127, &m_starMaxArea, 36);
        d.readDouble(128, &m_starMaxAspectRatio, 2.5);
        qint32 starDebugView = static_cast<qint32>(StarDebugViewOff);
        d.readS32(129, &starDebugView, static_cast<qint32>(StarDebugViewOff));
        ...
        d.readU32(130, &starColorRgba, QColor(120, 255, 255).rgba());
        m_starColor = QColor::fromRgba(starColorRgba);
        d.readBool(131, &m_plateSolve, false);
        d.readDouble(132, &m_plateSolveMaxMagnitude, 3.5);
        d.readS32(133, &m_plateSolveMinMatches, 4);
        d.readDouble(134, &m_plateSolveMatchRadius, 24.0);
        d.readDouble(135, &m_plateSolveFinalMatchRadius, m_plateSolveMatchRadius);
        d.readDouble(136, &m_plateSolveSearchRadius, 12.0);
        d.readBool(138, &m_plateSolveUseDownloadedCatalog, false);
        d.readBool(139, &m_plateSolveUseCurrentDateTime, true);
        qint64 plateSolveDateTimeMs = QDateTime::currentDateTime().toMSecsSinceEpoch();
        d.readS64(140, &plateSolveDateTimeMs, plateSolveDateTimeMs);
        ...
        d.readS32(141, &plateSolveApplyMode, static_cast<qint32>(PlateSolveApplyAzElRollFov));
        ...
        d.readS32(137, &plateSolveStartMode, plateSolveStartMode);
        ...
        d.readS32(142, &plateSolveLabelMode, static_cast<qint32>(PlateSolveLabelName));
        ...
        d.readS32(214, &videoPostProcessMode, videoPostProcessMode);
        m_recordMode = qBound(SavedMediaRaw, static_cast<SavedMediaMode>(videoPostProcessMode), SavedMediaBoth);
        d.readBool(143, &m_overlaySpectrum, false);
        d.readString(144, &m_spectrumDevice, "");
        d.readS32(145, &m_spectrumOffsetX, 0);
        d.readS32(146, &m_spectrumOffsetY, 0);
        ...
        d.readDouble(147, &m_spectrumScale, 1.0);
        m_spectrumScale = qBound(m_minSpectrumScale, m_spectrumScale, m_maxSpectrumScale);
        d.readString(148, &m_dateTimeFormat, "yyyy-MM-dd hh:mm:ss");
        d.readS32(149, &m_dateTimePosX, 4);
        d.readS32(150, &m_dateTimePosY, 0);
        ...
        d.readBool(158, &m_equatorialGrid, false);
        uint32_t equatorialGridColorRgba = QColor(80, 170, 255).rgba();
        d.readU32(159, &equatorialGridColorRgba, QColor(80, 170, 255).rgba());
        m_equatorialGridColor = QColor::fromRgba(equatorialGridColorRgba);
        d.readBool(160, &m_altAzGrid, false);
        uint32_t altAzGridColorRgba = QColor(255, 170, 80).rgba();
        d.readU32(161, &altAzGridColorRgba, QColor(255, 170, 80).rgba());
        m_altAzGridColor = QColor::fromRgba(altAzGridColorRgba);
        d.readBool(162, &m_constellation, false);
        uint32_t constellationColorRgba = QColor(255, 255, 120).rgba();
        d.readU32(163, &constellationColorRgba, QColor(255, 255, 120).rgba());
        m_constellationColor = QColor::fromRgba(constellationColorRgba);
        d.readS32(164, reinterpret_cast<qint32*>(&m_constellationOverlay), static_cast<qint32>(ConstellationOverlayUrsaMajor));
        ...
        d.readU32(167, &trackObjectColorRgba, QColor(80, 255, 80).rgba());
        m_trackObjectColor = QColor::fromRgba(trackObjectColorRgba);
        d.readDouble(168, &m_trackObjectFontScale, 9.0);
        m_trackObjectFontScale = qBound(m_minOverlayFontScale, m_trackObjectFontScale, m_maxOverlayFontScale);
        d.readString(169, &m_gridLabelFontFamily, "");
        d.readDouble(170, &m_gridLabelFontScale, 9.0);
        m_gridLabelFontScale = qBound(m_minOverlayFontScale, m_gridLabelFontScale, m_maxOverlayFontScale);
        d.readBool(151, &m_overlayText, false);
        d.readString(152, &m_overlayTextString, DEFAULT_OVERLAY_TEXT_STRING);
        uint32_t overlayTextColorRgba = QColor(Qt::white).rgba();
        d.readU32(153, &overlayTextColorRgba, QColor(Qt::white).rgba());
        m_overlayTextColor = QColor::fromRgba(overlayTextColorRgba);
        d.readString(154, &m_overlayTextFontFamily, "");
        d.readDouble(155, &m_overlayTextFontScale, 12.0);
        m_overlayTextFontScale = qBound(m_minOverlayFontScale, m_overlayTextFontScale, m_maxOverlayFontScale);
        d.readS32(156, &m_overlayTextPosX, 4);
        d.readS32(157, &m_overlayTextPosY, 0);
        ...
        d.readBool(171, &m_yoloEnabled, false);
        d.readString(172, &m_yoloModelPath, "");
        d.readString(173, &m_yoloLabelsPath, "");
        d.readDouble(174, &m_yoloConfThreshold, 0.5);
        d.readDouble(175, &m_yoloNmsThreshold, 0.45);
        ...
        d.readBool(203, &m_useReverseAPI);
        d.readString(204, &m_reverseAPIAddress);
        d.readU32(205, &utmp, 0);
        ...
        d.readS32(208, &m_asiCoolerOn, -1);
        d.readS32(209, &m_asiTargetTemp, std::numeric_limits<int>::min());
        d.readS32(210, &m_asiUsbBandwidth, -1);
        d.readS32(211, &m_asiHighSpeedMode, -1);
        d.readS32(212, (qint32 *) &m_asiColorImageType, (qint32) AsiColorImageTypeRgb24);
        d.readBool(215, &m_asiAutoExposureGain, false);
