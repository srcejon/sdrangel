...
QByteArray CameraSettings::serialize() const
{
    ...
    s.writeS32(118, m_starMinArea);
    s.writeS32(119, m_starMaxArea);
    s.writeDouble(120, m_starMaxAspectRatio);
    s.writeS32(121, static_cast<qint32>(m_starDebugView));
    s.writeU32(122, m_starColor.rgba());
    s.writeBool(123, m_plateSolve);
    s.writeDouble(124, m_plateSolveMaxMagnitude);
    s.writeS32(125, m_plateSolveMinMatches);
    s.writeDouble(126, m_plateSolveMatchRadius);
    s.writeDouble(127, m_plateSolveFinalMatchRadius);
    s.writeDouble(128, m_plateSolveSearchRadius);
    s.writeS32(129, static_cast<qint32>(m_plateSolveStartMode));
    s.writeBool(130, m_plateSolveUseDownloadedCatalog);
    s.writeBool(131, m_plateSolveUseCurrentDateTime);
    s.writeS64(132, m_plateSolveDateTime.isValid() ? m_plateSolveDateTime.toMSecsSinceEpoch() : 0);
    s.writeS32(133, static_cast<qint32>(m_plateSolveApplyMode));
    s.writeS32(134, static_cast<qint32>(m_plateSolveLabelMode));
    s.writeBool(135, m_overlaySpectrum);
    s.writeString(136, m_spectrumDevice);
    s.writeS32(137, m_spectrumOffsetX);
    s.writeS32(138, m_spectrumOffsetY);
    s.writeDouble(139, m_spectrumScale);
    s.writeString(140, m_dateTimeFormat);
    s.writeS32(141, m_dateTimePosX);
    s.writeS32(142, m_dateTimePosY);
    s.writeBool(143, m_overlayText);
    s.writeString(144, m_overlayTextString);
    s.writeU32(145, m_overlayTextColor.rgba());
    s.writeString(146, m_overlayTextFontFamily);
    s.writeDouble(147, m_overlayTextFontScale);
    s.writeS32(148, m_overlayTextPosX);
    s.writeS32(149, m_overlayTextPosY);
    s.writeBool(150, m_equatorialGrid);
    s.writeU32(151, m_equatorialGridColor.rgba());
    s.writeBool(152, m_altAzGrid);
    s.writeU32(153, m_altAzGridColor.rgba());
    s.writeBool(154, m_constellation);
    s.writeU32(155, m_constellationColor.rgba());
    s.writeS32(156, static_cast<qint32>(m_constellationOverlay));
    s.writeBool(157, m_trackObjects);
    s.writeDouble(158, m_trackObjectMinElevation);
    s.writeU32(159, m_trackObjectColor.rgba());
    s.writeDouble(160, m_trackObjectFontScale);
    s.writeString(161, m_gridLabelFontFamily);
    s.writeDouble(162, m_gridLabelFontScale);
    s.writeBool(163, m_yoloEnabled);
    s.writeString(164, m_yoloModelPath);
    s.writeString(165, m_yoloLabelsPath);
    s.writeDouble(166, m_yoloConfThreshold);
    s.writeDouble(167, m_yoloNmsThreshold);
    s.writeU32(168, m_yoloBoxColor.rgba());
    s.writeDouble(169, m_yoloDisappearDebounce);
    s.writeS32(170, m_yoloDnnTarget);
    s.writeBlob(171, serializeObjectDeviceSettings(m_objectDeviceSettings));
    s.writeBool(172, m_audioMute);
    s.writeString(173, m_audioDeviceName);
    s.writeS32(174, m_whiteBalanceMode);
    s.writeDouble(175, m_exposureCompensation);
    s.writeS32(176, m_focusMode);
    s.writeDouble(177, m_focusDistance);
    s.writeDouble(178, m_zoomFactor);
    s.writeDouble(179, m_captureInterval);
    s.writeS32(180, m_captureIntervalUnits);
    s.writeBool(181, m_alpacaDiscoveryEnabled);
    s.writeBool(182, m_alpacaApiLogEnabled);
    s.writeBool(183, m_alpacaFocuserEnabled);
    s.writeString(184, m_alpacaFocuserHost);
    s.writeU32(185, m_alpacaFocuserPort);
    s.writeS32(186, m_alpacaFocuserDeviceNumber);
    s.writeS32(187, m_alpacaFocusPosition);
    s.writeS32(188, m_alpacaFocusStepSize);
    s.writeBool(189, m_alpacaFilterWheelEnabled);
    s.writeString(190, m_alpacaFilterWheelHost);
    s.writeU32(191, m_alpacaFilterWheelPort);
    s.writeS32(192, m_alpacaFilterWheelDeviceNumber);
    s.writeS32(193, m_alpacaFilterWheelPosition);
    s.writeString(194, m_videoFileCameraPath);

    s.writeBool(195, m_useReverseAPI);
    s.writeString(196, m_reverseAPIAddress);
    s.writeU32(197, m_reverseAPIPort);
    s.writeU32(198, m_reverseAPIFeatureSetIndex);
    s.writeU32(199, m_reverseAPIFeatureIndex);
    s.writeS32(200, m_asiCoolerOn);
    s.writeS32(201, m_asiTargetTemp);
    s.writeS32(202, m_asiUsbBandwidth);
    s.writeS32(203, m_asiHighSpeedMode);
    s.writeS32(204, m_asiColorImageType);
    s.writeS32(205, m_diffMaskOpenSize);
    s.writeS32(206, m_recordMode);
    s.writeBool(207, m_asiAutoExposureGain);
    s.writeDouble(208, m_postProcessWhiteBalanceHighlightProtection);
...
bool CameraSettings::deserialize(const QByteArray& data)
{
    ...
    if (d.getVersion() == 1)
    {
        ...
        d.readU32(185, &utmp, 11111);
        m_alpacaFocuserPort = (utmp <= 65535) ? static_cast<uint16_t>(utmp) : 11111;
        d.readS32(186, &m_alpacaFocuserDeviceNumber, 0);
        d.readS32(187, &m_alpacaFocusPosition, 0);
        d.readS32(188, &m_alpacaFocusStepSize, 100);
        d.readBool(189, &m_alpacaFilterWheelEnabled, false);
        d.readString(190, &m_alpacaFilterWheelHost, "127.0.0.1");
        d.readU32(191, &utmp, 11111);
        m_alpacaFilterWheelPort = (utmp <= 65535) ? static_cast<uint16_t>(utmp) : 11111;
        d.readS32(192, &m_alpacaFilterWheelDeviceNumber, 0);
        d.readS32(193, &m_alpacaFilterWheelPosition, 0);
        ...
        d.readS32(205, &m_diffMaskOpenSize, 0);
        ...
        d.readS32(118, &m_starMinArea, 1);
        d.readS32(119, &m_starMaxArea, 36);
        d.readDouble(120, &m_starMaxAspectRatio, 2.5);
        qint32 starDebugView = static_cast<qint32>(StarDebugViewOff);
        d.readS32(121, &starDebugView, static_cast<qint32>(StarDebugViewOff));
        ...
        d.readU32(122, &starColorRgba, QColor(120, 255, 255).rgba());
        m_starColor = QColor::fromRgba(starColorRgba);
        d.readBool(123, &m_plateSolve, false);
        d.readDouble(124, &m_plateSolveMaxMagnitude, 3.5);
        d.readS32(125, &m_plateSolveMinMatches, 4);
        d.readDouble(126, &m_plateSolveMatchRadius, 24.0);
        d.readDouble(127, &m_plateSolveFinalMatchRadius, m_plateSolveMatchRadius);
        d.readDouble(128, &m_plateSolveSearchRadius, 12.0);
        d.readBool(130, &m_plateSolveUseDownloadedCatalog, false);
        d.readBool(131, &m_plateSolveUseCurrentDateTime, true);
        qint64 plateSolveDateTimeMs = QDateTime::currentDateTime().toMSecsSinceEpoch();
        d.readS64(132, &plateSolveDateTimeMs, plateSolveDateTimeMs);
        ...
        d.readS32(133, &plateSolveApplyMode, static_cast<qint32>(PlateSolveApplyAzElRollFov));
        ...
        d.readS32(129, &plateSolveStartMode, plateSolveStartMode);
        ...
        d.readS32(134, &plateSolveLabelMode, static_cast<qint32>(PlateSolveLabelName));
        ...
        d.readS32(206, &videoPostProcessMode, videoPostProcessMode);
        ...
        d.readS32(138, &m_spectrumOffsetY, 0);
        ...
        d.readDouble(139, &m_spectrumScale, 1.0);
        m_spectrumScale = qBound(m_minSpectrumScale, m_spectrumScale, m_maxSpectrumScale);
        d.readString(140, &m_dateTimeFormat, "yyyy-MM-dd hh:mm:ss");
        d.readS32(141, &m_dateTimePosX, 4);
        d.readS32(142, &m_dateTimePosY, 0);
        ...
        d.readBool(150, &m_equatorialGrid, false);
        uint32_t equatorialGridColorRgba = QColor(80, 170, 255).rgba();
        d.readU32(151, &equatorialGridColorRgba, QColor(80, 170, 255).rgba());
        m_equatorialGridColor = QColor::fromRgba(equatorialGridColorRgba);
        d.readBool(152, &m_altAzGrid, false);
        uint32_t altAzGridColorRgba = QColor(255, 170, 80).rgba();
        d.readU32(153, &altAzGridColorRgba, QColor(255, 170, 80).rgba());
        m_altAzGridColor = QColor::fromRgba(altAzGridColorRgba);
        d.readBool(154, &m_constellation, false);
        uint32_t constellationColorRgba = QColor(255, 255, 120).rgba();
        d.readU32(155, &constellationColorRgba, QColor(255, 255, 120).rgba());
        m_constellationColor = QColor::fromRgba(constellationColorRgba);
        d.readS32(156, reinterpret_cast<qint32*>(&m_constellationOverlay), static_cast<qint32>(ConstellationOverlayUrsaMajor));
        ...
        d.readU32(159, &trackObjectColorRgba, QColor(80, 255, 80).rgba());
        m_trackObjectColor = QColor::fromRgba(trackObjectColorRgba);
        d.readDouble(160, &m_trackObjectFontScale, 9.0);
        m_trackObjectFontScale = qBound(m_minOverlayFontScale, m_trackObjectFontScale, m_maxOverlayFontScale);
        d.readString(161, &m_gridLabelFontFamily, "");
        d.readDouble(162, &m_gridLabelFontScale, 9.0);
        m_gridLabelFontScale = qBound(m_minOverlayFontScale, m_gridLabelFontScale, m_maxOverlayFontScale);
        d.readBool(143, &m_overlayText, false);
        d.readString(144, &m_overlayTextString, DEFAULT_OVERLAY_TEXT_STRING);
        uint32_t overlayTextColorRgba = QColor(Qt::white).rgba();
        d.readU32(145, &overlayTextColorRgba, QColor(Qt::white).rgba());
        m_overlayTextColor = QColor::fromRgba(overlayTextColorRgba);
        d.readString(146, &m_overlayTextFontFamily, "");
        d.readDouble(147, &m_overlayTextFontScale, 12.0);
        m_overlayTextFontScale = qBound(m_minOverlayFontScale, m_overlayTextFontScale, m_maxOverlayFontScale);
        d.readS32(148, &m_overlayTextPosX, 4);
        d.readS32(149, &m_overlayTextPosY, 0);
        ...
        d.readBool(163, &m_yoloEnabled, false);
        d.readString(164, &m_yoloModelPath, "");
        d.readString(165, &m_yoloLabelsPath, "");
        d.readDouble(166, &m_yoloConfThreshold, 0.5);
        d.readDouble(167, &m_yoloNmsThreshold, 0.45);
        ...
        d.readBool(195, &m_useReverseAPI);
        d.readString(196, &m_reverseAPIAddress);
        ...
        d.readS32(200, &m_asiCoolerOn, -1);
        d.readS32(201, &m_asiTargetTemp, std::numeric_limits<int>::min());
        d.readS32(202, &m_asiUsbBandwidth, -1);
        d.readS32(203, &m_asiHighSpeedMode, -1);
        d.readS32(204, (qint32 *) &m_asiColorImageType, (qint32) AsiColorImageTypeRgb24);
        d.readBool(207, &m_asiAutoExposureGain, false);
