...
#ifndef INCLUDE_FEATURE_SCHEDULERPLUGIN_H_
#define INCLUDE_FEATURE_SCHEDULERPLUGIN_H_
...
class SchedulerPlugin : public QObject, PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID "sdrangel.feature.scheduler")
...
#endif // INCLUDE_FEATURE_SCHEDULERPLUGIN_H_
