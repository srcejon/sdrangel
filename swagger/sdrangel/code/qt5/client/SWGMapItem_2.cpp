...
QList<double>*
SWGMapItem_2::getTrackLatitudes() {
    return track_latitudes;
}
void
SWGMapItem_2::setTrackLatitudes(QList<double>* track_latitudes) {
    this->track_latitudes = track_latitudes;
    this->m_track_latitudes_isSet = true;
}

QList<double>*
SWGMapItem_2::getTrackLongitudes() {
    return track_longitudes;
}
void
SWGMapItem_2::setTrackLongitudes(QList<double>* track_longitudes) {
    this->track_longitudes = track_longitudes;
    this->m_track_longitudes_isSet = true;
}

QList<double>*
SWGMapItem_2::getTrackAltitudes() {
    return track_altitudes;
}
void
SWGMapItem_2::setTrackAltitudes(QList<double>* track_altitudes) {
    this->track_altitudes = track_altitudes;
    this->m_track_altitudes_isSet = true;
}

QList<qint64>*
SWGMapItem_2::getTrackDateTimeMsecs() {
    return track_date_time_msecs;
}
void
SWGMapItem_2::setTrackDateTimeMsecs(QList<qint64>* track_date_time_msecs) {
...
QList<double>*
SWGMapItem_2::getPredictedTrackLatitudes() {
    return predicted_track_latitudes;
}
void
SWGMapItem_2::setPredictedTrackLatitudes(QList<double>* predicted_track_latitudes) {
    this->predicted_track_latitudes = predicted_track_latitudes;
    this->m_predicted_track_latitudes_isSet = true;
}

QList<double>*
SWGMapItem_2::getPredictedTrackLongitudes() {
    return predicted_track_longitudes;
}
void
SWGMapItem_2::setPredictedTrackLongitudes(QList<double>* predicted_track_longitudes) {
    this->predicted_track_longitudes = predicted_track_longitudes;
    this->m_predicted_track_longitudes_isSet = true;
}

QList<double>*
SWGMapItem_2::getPredictedTrackAltitudes() {
    return predicted_track_altitudes;
}
void
SWGMapItem_2::setPredictedTrackAltitudes(QList<double>* predicted_track_altitudes) {
    this->predicted_track_altitudes = predicted_track_altitudes;
    this->m_predicted_track_altitudes_isSet = true;
}

QList<qint64>*
SWGMapItem_2::getPredictedTrackDateTimeMsecs() {
    return predicted_track_date_time_msecs;
}
void
SWGMapItem_2::setPredictedTrackDateTimeMsecs(QList<qint64>* predicted_track_date_time_msecs) {
...
SWGMapMesh*
SWGMapItem_2::getMesh() {
    return mesh;
}
void
SWGMapItem_2::setMesh(SWGMapMesh* mesh) {
    this->mesh = mesh;
