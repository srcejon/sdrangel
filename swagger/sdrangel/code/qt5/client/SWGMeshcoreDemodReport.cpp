...
SWGMeshcoreDemodReport::SWGMeshcoreDemodReport(QString* json) {
    init();
    this->fromJson(*json);
}

SWGMeshcoreDemodReport::SWGMeshcoreDemodReport() {
...
void
SWGMeshcoreDemodReport::cleanup() {
...
SWGMeshcoreDemodReport::fromJson(QString &json) {
...
void
SWGMeshcoreDemodReport::fromJsonObject(QJsonObject &pJson) {
...
QJsonObject*
SWGMeshcoreDemodReport::asJsonObject() {
...
float
SWGMeshcoreDemodReport::getChannelPowerDb() {
    return channel_power_db;
}
void
SWGMeshcoreDemodReport::setChannelPowerDb(float channel_power_db) {
    this->channel_power_db = channel_power_db;
    this->m_channel_power_db_isSet = true;
}

float
SWGMeshcoreDemodReport::getNoisePowerDb() {
    return noise_power_db;
}
void
SWGMeshcoreDemodReport::setNoisePowerDb(float noise_power_db) {
    this->noise_power_db = noise_power_db;
    this->m_noise_power_db_isSet = true;
}

float
SWGMeshcoreDemodReport::getSignalPowerDb() {
    return signal_power_db;
}
void
SWGMeshcoreDemodReport::setSignalPowerDb(float signal_power_db) {
    this->signal_power_db = signal_power_db;
    this->m_signal_power_db_isSet = true;
}

float
SWGMeshcoreDemodReport::getSnrPowerDb() {
    return snr_power_db;
}
void
SWGMeshcoreDemodReport::setSnrPowerDb(float snr_power_db) {
    this->snr_power_db = snr_power_db;
    this->m_snr_power_db_isSet = true;
}

qint32
SWGMeshcoreDemodReport::getChannelSampleRate() {
    return channel_sample_rate;
}
void
SWGMeshcoreDemodReport::setChannelSampleRate(qint32 channel_sample_rate) {
    this->channel_sample_rate = channel_sample_rate;
    this->m_channel_sample_rate_isSet = true;
}

qint32
SWGMeshcoreDemodReport::getSyncWord() {
    return sync_word;
}
void
SWGMeshcoreDemodReport::setSyncWord(qint32 sync_word) {
    this->sync_word = sync_word;
    this->m_sync_word_isSet = true;
}

qint32
SWGMeshcoreDemodReport::getNbParityBits() {
    return nb_parity_bits;
}
void
SWGMeshcoreDemodReport::setNbParityBits(qint32 nb_parity_bits) {
    this->nb_parity_bits = nb_parity_bits;
    this->m_nb_parity_bits_isSet = true;
}

qint32
SWGMeshcoreDemodReport::getPacketLength() {
    return packet_length;
}
void
SWGMeshcoreDemodReport::setPacketLength(qint32 packet_length) {
    this->packet_length = packet_length;
    this->m_packet_length_isSet = true;
}

qint32
SWGMeshcoreDemodReport::getNbSymbols() {
    return nb_symbols;
}
void
SWGMeshcoreDemodReport::setNbSymbols(qint32 nb_symbols) {
    this->nb_symbols = nb_symbols;
    this->m_nb_symbols_isSet = true;
}

qint32
SWGMeshcoreDemodReport::getNbCodewords() {
    return nb_codewords;
}
void
SWGMeshcoreDemodReport::setNbCodewords(qint32 nb_codewords) {
    this->nb_codewords = nb_codewords;
    this->m_nb_codewords_isSet = true;
}

qint32
SWGMeshcoreDemodReport::getHeaderParityStatus() {
    return header_parity_status;
}
void
SWGMeshcoreDemodReport::setHeaderParityStatus(qint32 header_parity_status) {
    this->header_parity_status = header_parity_status;
    this->m_header_parity_status_isSet = true;
}

qint32
SWGMeshcoreDemodReport::getHeaderCrcStatus() {
    return header_crc_status;
}
void
SWGMeshcoreDemodReport::setHeaderCrcStatus(qint32 header_crc_status) {
    this->header_crc_status = header_crc_status;
    this->m_header_crc_status_isSet = true;
}

qint32
SWGMeshcoreDemodReport::getPayloadParityStatus() {
    return payload_parity_status;
}
void
SWGMeshcoreDemodReport::setPayloadParityStatus(qint32 payload_parity_status) {
    this->payload_parity_status = payload_parity_status;
    this->m_payload_parity_status_isSet = true;
}

qint32
SWGMeshcoreDemodReport::getPayloadCrcStatus() {
    return payload_crc_status;
}
void
SWGMeshcoreDemodReport::setPayloadCrcStatus(qint32 payload_crc_status) {
    this->payload_crc_status = payload_crc_status;
    this->m_payload_crc_status_isSet = true;
}

QString*
SWGMeshcoreDemodReport::getMessageTimestamp() {
    return message_timestamp;
}
void
SWGMeshcoreDemodReport::setMessageTimestamp(QString* message_timestamp) {
    this->message_timestamp = message_timestamp;
    this->m_message_timestamp_isSet = true;
}

QString*
SWGMeshcoreDemodReport::getMessageString() {
    return message_string;
}
void
SWGMeshcoreDemodReport::setMessageString(QString* message_string) {
    this->message_string = message_string;
    this->m_message_string_isSet = true;
}

QString*
SWGMeshcoreDemodReport::getFrameType() {
    return frame_type;
}
void
SWGMeshcoreDemodReport::setFrameType(QString* frame_type) {
    this->frame_type = frame_type;
    this->m_frame_type_isSet = true;
}

QString*
SWGMeshcoreDemodReport::getChannelType() {
    return channel_type;
}
void
SWGMeshcoreDemodReport::setChannelType(QString* channel_type) {
    this->channel_type = channel_type;
    this->m_channel_type_isSet = true;
}

QList<QString*>*
SWGMeshcoreDemodReport::getMessageBytes() {
    return message_bytes;
}
void
SWGMeshcoreDemodReport::setMessageBytes(QList<QString*>* message_bytes) {
    this->message_bytes = message_bytes;
    this->m_message_bytes_isSet = true;
}

qint32
SWGMeshcoreDemodReport::getDecoding() {
    return decoding;
}
void
SWGMeshcoreDemodReport::setDecoding(qint32 decoding) {
