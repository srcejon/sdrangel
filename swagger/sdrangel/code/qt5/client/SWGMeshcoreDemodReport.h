...
/*
 * SWGMeshcoreDemodReport.h
 *
 * MeshcoreDemod
 */

#ifndef SWGMeshcoreDemodReport_H_
#define SWGMeshcoreDemodReport_H_
...
class SWG_API SWGMeshcoreDemodReport: public SWGObject {
public:
    SWGMeshcoreDemodReport();
    SWGMeshcoreDemodReport(QString* json);
    virtual ~SWGMeshcoreDemodReport();
    void init();
    void cleanup();
    ...
    virtual SWGMeshcoreDemodReport* fromJson(QString &jsonString) override;
...
#endif /* SWGMeshcoreDemodReport_H_ */
