...
/*
 * SWGMeshcoreDemodSettings.h
 *
 * MeshcoreDemod
 */

#ifndef SWGMeshcoreDemodSettings_H_
#define SWGMeshcoreDemodSettings_H_
...
class SWG_API SWGMeshcoreDemodSettings: public SWGObject {
public:
    SWGMeshcoreDemodSettings();
    SWGMeshcoreDemodSettings(QString* json);
    virtual ~SWGMeshcoreDemodSettings();
    void init();
    void cleanup();
    ...
    virtual SWGMeshcoreDemodSettings* fromJson(QString &jsonString) override;
...
#endif /* SWGMeshcoreDemodSettings_H_ */
