...
/*
 * SWGMeshcoreModReport.h
 *
 * MeshcoreMod
 */

#ifndef SWGMeshcoreModReport_H_
#define SWGMeshcoreModReport_H_
...
class SWG_API SWGMeshcoreModReport: public SWGObject {
public:
    SWGMeshcoreModReport();
    SWGMeshcoreModReport(QString* json);
    virtual ~SWGMeshcoreModReport();
    void init();
    void cleanup();
    ...
    virtual SWGMeshcoreModReport* fromJson(QString &jsonString) override;
