...
SWGMeshcoreModSettings::SWGMeshcoreModSettings(QString* json) {
    init();
    this->fromJson(*json);
}

SWGMeshcoreModSettings::SWGMeshcoreModSettings() {
...
void
SWGMeshcoreModSettings::cleanup() {
...
SWGMeshcoreModSettings::fromJson(QString &json) {
...
void
SWGMeshcoreModSettings::fromJsonObject(QJsonObject &pJson) {
...
QJsonObject*
SWGMeshcoreModSettings::asJsonObject() {
...
qint64
SWGMeshcoreModSettings::getInputFrequencyOffset() {
    return input_frequency_offset;
}
void
SWGMeshcoreModSettings::setInputFrequencyOffset(qint64 input_frequency_offset) {
    this->input_frequency_offset = input_frequency_offset;
    this->m_input_frequency_offset_isSet = true;
}

qint32
SWGMeshcoreModSettings::getBandwidthIndex() {
    return bandwidth_index;
}
void
SWGMeshcoreModSettings::setBandwidthIndex(qint32 bandwidth_index) {
    this->bandwidth_index = bandwidth_index;
    this->m_bandwidth_index_isSet = true;
}

qint32
SWGMeshcoreModSettings::getSpreadFactor() {
    return spread_factor;
}
void
SWGMeshcoreModSettings::setSpreadFactor(qint32 spread_factor) {
    this->spread_factor = spread_factor;
    this->m_spread_factor_isSet = true;
}

qint32
SWGMeshcoreModSettings::getDeBits() {
    return de_bits;
}
void
SWGMeshcoreModSettings::setDeBits(qint32 de_bits) {
    this->de_bits = de_bits;
    this->m_de_bits_isSet = true;
}

qint32
SWGMeshcoreModSettings::getPreambleChirps() {
    return preamble_chirps;
}
void
SWGMeshcoreModSettings::setPreambleChirps(qint32 preamble_chirps) {
    this->preamble_chirps = preamble_chirps;
    this->m_preamble_chirps_isSet = true;
}

qint32
SWGMeshcoreModSettings::getQuietMillis() {
    return quiet_millis;
}
void
SWGMeshcoreModSettings::setQuietMillis(qint32 quiet_millis) {
    this->quiet_millis = quiet_millis;
    this->m_quiet_millis_isSet = true;
}

qint32
SWGMeshcoreModSettings::getSyncWord() {
    return sync_word;
}
void
SWGMeshcoreModSettings::setSyncWord(qint32 sync_word) {
    this->sync_word = sync_word;
    this->m_sync_word_isSet = true;
}

qint32
SWGMeshcoreModSettings::getChannelMute() {
    return channel_mute;
}
void
SWGMeshcoreModSettings::setChannelMute(qint32 channel_mute) {
    this->channel_mute = channel_mute;
    this->m_channel_mute_isSet = true;
}

qint32
SWGMeshcoreModSettings::getNbParityBits() {
    return nb_parity_bits;
}
void
SWGMeshcoreModSettings::setNbParityBits(qint32 nb_parity_bits) {
    this->nb_parity_bits = nb_parity_bits;
    this->m_nb_parity_bits_isSet = true;
}

QString*
SWGMeshcoreModSettings::getTextMessage() {
    return text_message;
}
void
SWGMeshcoreModSettings::setTextMessage(QString* text_message) {
    this->text_message = text_message;
    this->m_text_message_isSet = true;
}

qint32
SWGMeshcoreModSettings::getMessageRepeat() {
    return message_repeat;
}
void
SWGMeshcoreModSettings::setMessageRepeat(qint32 message_repeat) {
    this->message_repeat = message_repeat;
    this->m_message_repeat_isSet = true;
}

qint32
SWGMeshcoreModSettings::getUdpEnabled() {
    return udp_enabled;
}
void
SWGMeshcoreModSettings::setUdpEnabled(qint32 udp_enabled) {
    this->udp_enabled = udp_enabled;
    this->m_udp_enabled_isSet = true;
}

QString*
SWGMeshcoreModSettings::getUdpAddress() {
    return udp_address;
}
void
SWGMeshcoreModSettings::setUdpAddress(QString* udp_address) {
    this->udp_address = udp_address;
    this->m_udp_address_isSet = true;
}

qint32
SWGMeshcoreModSettings::getUdpPort() {
    return udp_port;
}
void
SWGMeshcoreModSettings::setUdpPort(qint32 udp_port) {
    this->udp_port = udp_port;
    this->m_udp_port_isSet = true;
}

qint32
SWGMeshcoreModSettings::getInvertRamps() {
    return invert_ramps;
}
void
SWGMeshcoreModSettings::setInvertRamps(qint32 invert_ramps) {
    this->invert_ramps = invert_ramps;
    this->m_invert_ramps_isSet = true;
}

qint32
SWGMeshcoreModSettings::getRgbColor() {
    return rgb_color;
}
void
SWGMeshcoreModSettings::setRgbColor(qint32 rgb_color) {
    this->rgb_color = rgb_color;
    this->m_rgb_color_isSet = true;
}

QString*
SWGMeshcoreModSettings::getTitle() {
    return title;
}
void
SWGMeshcoreModSettings::setTitle(QString* title) {
    this->title = title;
    this->m_title_isSet = true;
}

qint32
SWGMeshcoreModSettings::getStreamIndex() {
    return stream_index;
}
void
SWGMeshcoreModSettings::setStreamIndex(qint32 stream_index) {
    this->stream_index = stream_index;
    this->m_stream_index_isSet = true;
}

qint32
SWGMeshcoreModSettings::getUseReverseApi() {
    return use_reverse_api;
}
void
SWGMeshcoreModSettings::setUseReverseApi(qint32 use_reverse_api) {
    this->use_reverse_api = use_reverse_api;
    this->m_use_reverse_api_isSet = true;
}

QString*
SWGMeshcoreModSettings::getReverseApiAddress() {
    return reverse_api_address;
}
void
SWGMeshcoreModSettings::setReverseApiAddress(QString* reverse_api_address) {
    this->reverse_api_address = reverse_api_address;
    this->m_reverse_api_address_isSet = true;
}

qint32
SWGMeshcoreModSettings::getReverseApiPort() {
    return reverse_api_port;
}
void
SWGMeshcoreModSettings::setReverseApiPort(qint32 reverse_api_port) {
    this->reverse_api_port = reverse_api_port;
    this->m_reverse_api_port_isSet = true;
}

qint32
SWGMeshcoreModSettings::getReverseApiDeviceIndex() {
    return reverse_api_device_index;
}
void
SWGMeshcoreModSettings::setReverseApiDeviceIndex(qint32 reverse_api_device_index) {
    this->reverse_api_device_index = reverse_api_device_index;
    this->m_reverse_api_device_index_isSet = true;
}

qint32
SWGMeshcoreModSettings::getReverseApiChannelIndex() {
    return reverse_api_channel_index;
}
void
SWGMeshcoreModSettings::setReverseApiChannelIndex(qint32 reverse_api_channel_index) {
    this->reverse_api_channel_index = reverse_api_channel_index;
    this->m_reverse_api_channel_index_isSet = true;
}

SWGChannelMarker*
SWGMeshcoreModSettings::getChannelMarker() {
    return channel_marker;
}
void
SWGMeshcoreModSettings::setChannelMarker(SWGChannelMarker* channel_marker) {
    this->channel_marker = channel_marker;
    this->m_channel_marker_isSet = true;
}

SWGRollupState*
SWGMeshcoreModSettings::getRollupState() {
    return rollup_state;
}
void
SWGMeshcoreModSettings::setRollupState(SWGRollupState* rollup_state) {
