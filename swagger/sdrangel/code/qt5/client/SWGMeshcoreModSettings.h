...
/*
 * SWGMeshcoreModSettings.h
 *
 * MeshcoreMod
 */

#ifndef SWGMeshcoreModSettings_H_
#define SWGMeshcoreModSettings_H_
...
class SWG_API SWGMeshcoreModSettings: public SWGObject {
public:
    SWGMeshcoreModSettings();
    SWGMeshcoreModSettings(QString* json);
    virtual ~SWGMeshcoreModSettings();
    void init();
    void cleanup();
    ...
    virtual SWGMeshcoreModSettings* fromJson(QString &jsonString) override;
...
#endif /* SWGMeshcoreModSettings_H_ */
